return {
    ...
    keys = {
        ...
        { '<c-e>', '<cmd>lua require("cinnamon").scroll("10<C-e>zz")<cr>', mode = 'n', desc = "Scroll down 10 lines smoothly" },
        { '<c-y>', '<cmd>lua require("cinnamon").scroll("10<C-y>zz")<cr>', mode = 'n', desc = "Scroll up 10 lines smoothly" },
    }
}
